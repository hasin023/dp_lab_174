public class App {
        public static void main(String[] args) throws Exception {
                ...
                // System.out.println("Rider: " + hasin_r88822.getName() + ", Location: " +
                // hasin_r88822.getLocation());
                ...
                // System.out.println(
                // "Driver: " + sinthia_d44421.getName() + ", Location: " +
                // sinthia_d44421.getLocation());

                // Trip emk_center = hasin_r88822.requestRide("EMK Center, Dhanmondi",
                // "Bashundhara City, Panthapath",
                // RideType.CARPOOL);
                // System.out.println("Trip requested: " + emk_center.getId() + ", Rider: " +
                // hasin_r88822.getName()
                // + ", Pickup: "
                // + emk_center.getPickupLocation() + ", Dropoff: " +
                // emk_center.getDropOffLocation());

                // sinthia_d44421.cancelRide(emk_center);

                // Trip dhanmondi = hasin_r88822.requestRide("Dhanmondi 27", "Bashundhara City,
                // Panthapath",
                // RideType.CARPOOL);
                // System.out.println("Trip requested: " + dhanmondi.getId() + ", Rider: " +
                // hasin_r88822.getName()
                // + ", Pickup: "
                // + dhanmondi.getPickupLocation() + ", Dropoff: " +
                // dhanmondi.getDropOffLocation());

                // sinthia_d44421.acceptRide(dhanmondi);

                // sinthia_d44421.receiveNotification("Trip assigned: " + dhanmondi.getId());
                // hasin_r88822.receiveNotification("Driver assigned: " +
                // sinthia_d44421.getName());

                // sinthia_d44421.updateLocation("Dhanmondi 27");
                // System.out.println("Driver " + sinthia_d44421.getName() + " is at " +
                // sinthia_d44421.getLocation());
